...
import org.wildfly.extension.microprofile.config.module.ConfigSourceFromClassTestCase;
import org.wildfly.extension.microprofile.config.module.CustomConfigSource;

/**
 * @author <a href="http://jmesnil.net/">Jeff Mesnil</a> (c) 2017 Red Hat inc.
 */
public class ConfigSourceProviderFromClassSetupTask implements ServerSetupTask {
    ...
    private void addConfigSourceProvider(ModelControllerClient client) throws IOException {
        ...
        op.get(OP_ADDR).add("config-source-provider", "my-config-source-provider");
        op.get(OP).set(ADD);
