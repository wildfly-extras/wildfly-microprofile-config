 ...
 */
public class JSRConfigProviderService implements Service<ConfigProviderResolver> {

    private JSRConfigProviderService() {

    }

    public static void install(OperationContext context) {
        JSRConfigProviderService service = new JSRConfigProviderService();
        context.getServiceTarget().addService(ServiceNames.JSR_CONFIG_PROVIDER, service)
                .install();
    }
